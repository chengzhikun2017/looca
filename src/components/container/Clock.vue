<template>
  <div class="clock">
    <span class="clock-item clock-hour">{{clock.hour}}时</span>
    <span class="clock-item clock-minute">{{clock.minute}}分</span>
    <span class="clock-item clock-second">{{clock.second}}秒</span>
  </div>
</template>
<script>
class Clock {
